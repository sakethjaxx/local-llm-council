...
```bash
PYTHONPATH=src uvicorn council.main:app --host 127.0.0.1 --port 8765
```
...
- attach file: `demo_samples/architecture_brief.md`
...
- attach:
  - `demo_samples/code_review_request.md`
  - `demo_samples/demo_metrics.json`
...
- attach: `demo_samples/product_demo_notes.md`
- click `Run council`
...
You can write this in [the demo scorecard template](demo_scorecard_template.md).
...
- `Fast Triage` + `demo_samples/architecture_brief.md`
- `Code Review` + `demo_samples/code_review_request.md` + `demo_samples/demo_metrics.json`
- `Product Review` + `demo_samples/product_demo_notes.md`
