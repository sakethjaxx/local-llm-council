...
Monthly runs are for strategic issues — don't try to fix monthly findings in the same session. File them in [the improvement plan](../plans/IMPROVEMENT_PLAN.md).
